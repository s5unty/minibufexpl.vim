...
if has("gui_running")
    ...
    noremap  <Esc>,     :call BufPrevPart()<cr>
    noremap  <Esc>.     :call BufNextPart()<cr>
    noremap  <Esc><space>  :call BufEcho()<cr>
endif
    ...
    for i in keys(s:bufs)
        if i < 10
            if has("gui_running")
                ...
                exec "silent! unmap <Esc>".i
            endif
        else
            if has("gui_running")
                exec "silent! unmap <M-".i/10."><M-".i%10.">"
            else
                exec "silent! unmap <Esc>".i/10"<Esc>".i%10
            endif
        endif
    ...
    for i in keys(s:bufs)
        if i < 10
            if has("gui_running")
                ...
                exec "silent! noremap <Esc>".i." :call BufChange(".i.")<CR>"
            endif
        else
            if has("gui_running")
                exec "silent! noremap <M-".i/10."><M-".i%10."> :call BufChange(".i.")<CR>"
            else
                exec "silent! noremap <Esc>".i/10."<Esc>".i%10." :call BufChange(".i.")<CR>"
            endif
        endif
